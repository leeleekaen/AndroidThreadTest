...
public class MyAsyncTaskActivity extends AppCompatActivity {
    ...
    private class MyAsyncTask extends AsyncTask<String,Object,Long>{
        ...
        protected void onPreExecute() {
            Log.i("download","MyAsyncTask:onPreExecute,Thread name: \" "+ Thread.currentThread().getName());
            super.onPreExecute();
        ...
        protected Long doInBackground(String... strings) {
            Log.i("download","MyAsyncTask:doInBackground,Thread name: \" "+ Thread.currentThread().getName());
            long totalByte = 0;
        ...
        protected void onProgressUpdate(Object... values) {
            Log.i("download","MyAsyncTask:onProgressUpdate,Thread name: \" "+ Thread.currentThread().getName());
        ...
        protected void onCancelled() {
            Log.i("download","MyAsyncTask:onCancelled,Thread name: \" "+ Thread.currentThread().getName());
            super.onCancelled();
            mStatuText.setText("取消下载");
            mDownButton.setEnabled(true);
            mDownButton.setText("开始下载");
